            ...
            <div class="card-group">
                <div class="col-md-4">
                    <div class="card">
                        <img class="rounded-circle img-thumbnail mt-3"
                            src="<?= base_url('assets/uploads/profile/' . $dosen['foto']); ?>" alt="Card image cap"
                            width="150" height="150" style="display: block; margin: 0 auto;" id="gambar_nodin">
                        <div class="card-body">
                            <form action="<?= base_url('dosen/updateFoto'); ?>" method="post"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="username" name="username"
                                        autocomplete="off" value="<?= $dosen['username']; ?>">
                                </div>
                                <div class="form-group">
                                    <label for="nama">Nama</label>
                                    <input type="text" class="form-control" readonly id="nama" name="nama" required
                                        autocomplete="off" value="<?= $dosen['nama']; ?>">
                                </div>
                                <div class="form-group">
                ...
                <div class="col-md-4">
                    <div class="card">
                        ...
                        <div class="card-body ">
                            <form action="<?= base_url('dosen/updatePass'); ?>" method="post">
                                <input type="hidden" value="<?= $dosen['id']; ?>" name="id">
                                <input type="hidden" name="<?php echo $this->security->get_csrf_token_name(); ?>"
                                    value="<?php echo $this->security->get_csrf_hash(); ?>">
                                <div class="form-group">
