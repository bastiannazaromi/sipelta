            ...
            <div class="card">
                <div class="card-body">
                    <div class="table-responsive">
                        <?php echo form_open('admin/persetujuan/multiple_delete'); ?>
                        ...
                        <table id="example" class="table table-bordered table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?= $hasil['judul']; ?></td>
                                    <td>
                                        <a href="<?= base_url('assets/uploads/persetujuan/' . $hasil['nama_file']); ?>"
...
$(document).ready(function() {
    ...
    $('#by_tahun').change(function() {
        ...
        document.location.href = '<?= base_url('admin/persetujuan/'); ?>' +
            tahun;
    });
